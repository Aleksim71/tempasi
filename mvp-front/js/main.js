/*-----------------------------------------------------------------------------------
  ...
  Template Name: TEMPASI				 eCommerce HTML5 Template.
  Template URI: #
...
---------------------------------
  ...
  08. Fixed Footer bottom script ( blogletter )
  09. Search Bar
  10. Toogle Menu
...
--------------------------------------------------------*/
	...
	var $blogletter_height = $('.htc__foooter__area');
	$('.fixed__footer').css({
		'margin-bottom': $blogletter_height.height() + 'px',
	});
